...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteDTO objtDto) {
		return new Cliente(objtDto.getId(), objtDto.getNome(), objtDto.getEmail(), null, null, null);
		
	}
	
	public Cliente fromDTO(ClienteNewDTO objtDto) {
		 Cliente cli = new Cliente(null, objtDto.getNome(), objtDto.getEmail(), objtDto.getCpfOuCnpj(), TipoCliente.toEnum(objtDto.getTipo()), pe.encode(objtDto.getSenha()));
